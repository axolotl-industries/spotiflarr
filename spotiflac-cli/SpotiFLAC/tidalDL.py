...
class TidalDownloader:
    ...
    def get_available_apis() -> List[str]:
        # Spotbye proxy (extracted from SpotiFLAC-Next AppImage). This is the
        # endpoint the official Next GUI uses today; the qqdl/kinoplus mirrors
        # below are the upstream fallbacks and are mostly dead as of mid-2026
        # but kept in the rotation in case Spotbye rate-limits us.
        return [
            "https://tdlalt.spotbye.qzz.io",
